 ...
 */
struct gkyl_wv_eqn* gkyl_wv_gr_maxwell_new(double c, double e_fact, double b_fact);

/**
 * Create a new Maxwell equation object that lives on NV-GPU.
 * see new() method above for documentation.
 */
struct gkyl_wv_eqn* gkyl_wv_gr_maxwell_cu_dev_new(double c, double e_fact, double b_fact);
